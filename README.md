...
#### 📊 GitHub Stats:
<button id="toggleStats">Show GitHub Stats</button>
<div id="githubStats" style="display:none;">
...
<script>
    document.getElementById("toggleStats").addEventListener("click", function() {
        ...
        if (stats.style.display === "none") {
            ...
            this.textContent = "Hide GitHub Stats";
        } else {
            stats.style.display = "none";
            this.textContent = "Show GitHub Stats";
        }
    });
</script>
